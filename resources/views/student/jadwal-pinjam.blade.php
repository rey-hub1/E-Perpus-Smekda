...
<div class="max-w-2xl mx-auto">
    ...
    <!-- Book Info Card -->
    <div class="bg-white border border-gray-100 rounded-2xl p-5 mb-6 flex items-center gap-5">
        <div class="shrink-0 w-16 h-22">
            @if ($book->gambar)
                <img src="{{ $book->cover_url }}" alt="{{ $book->judul }}"
                    class="w-16 h-22 object-cover rounded-lg shadow-md">
            @else
                <div class="w-16 h-22 bg-gradient-to-br from-gray-600 to-gray-800 rounded-lg flex items-center justify-center">
                    <svg class="w-6 h-6 text-white/40" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
    ...
    <form action="{{ route('pinjam.buku', $book->id) }}" method="POST" id="jadwalForm">
        ...
        <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden mb-5">
            ...
            <div class="p-6 border-b border-gray-100">
                ...
                <input
                    ...
                    class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm font-medium text-text focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all"
                    required
                >
            ...
            <div class="p-6 bg-gray-50">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-bold text-red-500" id="displayDue">—</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-xl px-5 py-4 mb-6 flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-amber-700 mt-0.5 leading-relaxed">
                    ...
                    Keterlambatan pengembalian akan dikenakan denda <span class="font-semibold">Rp1.000 per hari</span>.
                </p>
            </div>
        </div>
        ...
        <!-- Submit -->
        <button type="submit"
            class="w-full bg-primary hover:bg-secondary text-white font-bold text-base py-4 rounded-xl transition-all hover:shadow-lg hover:shadow-primary/20 flex items-center justify-center gap-2">
