            ...
            <div class="px-6 py-5 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="4"
                        class="w-full border border-text/10 rounded-lg px-3.5 py-2.5 text-sm bg-background text-text focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all resize-none">{{ old('deskripsi', $book->deskripsi) }}</textarea>
                </div>
            ...
            <div class="px-6 py-5">
                ...
                @if ($book->gambar)
                    <div class="flex items-start gap-5 mb-4" id="currentCoverContainer">
                        <img src="{{ $book->cover_url }}" class="w-16 h-22 object-cover rounded-lg border border-text/10 shadow-sm text-text">
                        <div>
                            <p class="text-xs font-semibold text-text/50 mb-1">Cover saat ini</p>
                            <p class="text-xs text-text/40">Upload file baru untuk mengganti cover.</p>
                        </div>
                    </div>
                @endif
                ...
                <p class="text-xs text-text/30 mt-2">Maksimal 5MB. Format: JPG, PNG, JPEG. Biarkan kosong jika tidak ingin mengganti cover.</p>

                <div id="cropperContainer" class="hidden mt-4">
                    <p class="text-xs font-semibold text-text/60 mb-2">Sesuaikan posisi cover baru:</p>
